...
import { FontAwesomeIcon, iconTruck, iconMapPin, iconChevronRight, iconCheckCircle, iconTrash2 } from "@/lib/icons";
    ...
    <>
      <div className="gradient-active-trip rounded-xl p-5 cursor-pointer transition-all hover:scale-[1.01]"
        ...
        <div className="flex items-center justify-between mb-3">
          ...
          <FontAwesomeIcon icon={iconChevronRight} className="w-5 h-5 text-muted-foreground" />
        </div>
        ...
        <div className="flex items-center gap-3 mb-4">
          <FontAwesomeIcon icon={iconMapPin} className="w-5 h-5 text-muted-foreground" />
